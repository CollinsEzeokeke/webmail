...
export function AppearanceSettings() {
  ...
  const { fontSize, density, animationsEnabled, senderFavicons, gravatarEnabled, showAvatarsInJunk, updateSetting } = useSettingsStore();
  ...
  return (
    <SettingsSection title={t('title')} description={t('description')}>
      ...
      <SettingItem label={tAdvanced('gravatar_avatars.label')} description={tAdvanced('gravatar_avatars.description')}>
        <ToggleSwitch checked={gravatarEnabled} onChange={(checked) => updateSetting('gravatarEnabled', checked)} />
      </SettingItem>
